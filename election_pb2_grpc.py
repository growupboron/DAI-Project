...
class ElectionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sendElectionMessage = channel.unary_unary(
                '/Election/sendElectionMessage',
                request_serializer=election__pb2.ElectionMessage.SerializeToString,
...
def add_ElectionServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'sendElectionMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=election__pb2.ElectionMessage.FromString,
...
class Election(object):
    ...
    def sendElectionMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Election/sendElectionMessage',
            election__pb2.ElectionMessage.SerializeToString,
